...
# From tokio-native-tls
# https://github.com/tokio-rs/tls/blob/7ea7a17831691e8b0a9cfae3132d2d2f0f64221c/tokio-native-tls/scripts/generate-certificate.sh
...
openssl req -x509 -new -key $ROOT_CA_KEY -out $ROOT_CA -days 365 -SHA256 -subj "/C=AU/ST=Some-State/O=Internet Widgets Pty Ltd" -config root.cnf -extensions v3_ca
